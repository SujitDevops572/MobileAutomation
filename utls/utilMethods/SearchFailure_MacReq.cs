...
{
    public class SearchFailure_MacReq
    {
            ...
            string module)
        {
            ...
            try
            {
                Console.WriteLine($"Navigating to Menu: {menuData}, Submenu: {submenuData}, Option:{Option}");
                ...
                SafeClickWithScrollAndJS(driver, wait, By.XPath(Option));
                Thread.Sleep(1500);
