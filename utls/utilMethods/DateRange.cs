    ...
    public class DateRange
    {
            ...
            string module)
        {
            ...
            try
            {
                ...
                Thread.Sleep(3000); // Added wait time to ensure table reloads
        ...
        private static void ClickDateIcon(WebDriverWait wait)
        {
            wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("//mat-icon[text()='date_range']"))).Click();
        }
        ...
        private static void ValidateDateRange(WebDriverWait wait, IWebDriver driver)
        {
            ...
            for (int rowIndex = 1; rowIndex <= rows.Count; rowIndex++)
            {
                ...
                {
                    Console.WriteLine($" Stale element at row {rowIndex}, retrying...");
                    rowIndex--; // Retry same row
                }
            }
