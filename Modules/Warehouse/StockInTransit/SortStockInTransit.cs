...
{
    [TestClass]
    public class SortStockInTransit
    {
        ...
        [TestMethod]
        public void SortStockInTransitListSuccess()
        {
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse2", "Stock In Transit List");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("sort the stock in transit");
            //description = "test case to test sort stock in transit with available options. make sure stock in transit has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortStockInTransitListFailure()
        {

            expectedStatus = "Failed";

            description = "Verify all Sort Stock In Transit List Failure.";
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse2", "Stock In Transit List");
