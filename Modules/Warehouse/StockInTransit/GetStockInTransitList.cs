...
{
    [TestClass]
    public class GetStockInTransitList
    {
        ...
        [TestMethod]
        public void GetStockInTransitListSuccess()
        {
            expectedStatus = "Passed";
            test = extent.CreateTest("stock in transit displayed");
            description = "test case to test stock in transit displayed";
        ...
        [TestMethod]
        public void GetStockInTransitListFailure()
        {
            expectedStatus = "Failed";
            test = extent.CreateTest("Stock in Transit is not displayed");
            description = "test case to test stock in transit is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
