...
namespace VMS_Phase1PortalAT.Modules.Warehouse.StockInTransit
{
    ...
    public class SearchStockInTransit
    {
        ...
        [TestMethod]
        public void SearchCurrentStockSuccess()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse3", SearchStockInTransitData.searchStockInTransitSuccess, 1, "Stock In Transit");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("search stockin transit");
            //description = "test case to search stock in transit with valid datas so it return datas. add valid data in searchStockInTransitSuccess in SearchStockInTransitData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchStockInTransitData.searchStockInTransitSuccess[item.Text]);
        ...
        [TestMethod]
        public void SearchCurrentStockFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse3", SearchStockInTransitData.searchStockInTransitFailure, 0, "Stock In Transit");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("search stock in transit");
            //description = "test case to search stock in transit with invalid datas so it return datas. add valid data in searchStockInTransitFailure in SearchStockInTransitData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchStockInTransitData.searchStockInTransitFailure[item.Text]);
            //                searchInput.SendKeys(Keys.Enter);
            //                Thread.Sleep(2000);
