...
{
    [TestClass]
    public class GetScrappedStockList
    {
        ...
        [TestMethod]
        public void GetScrappedListSuccess()
        {
            test = extent.CreateTest("Validating Get Scrapped List Success");


            expectedStatus = "Passed";
            description = "test case to test scrapped stock list displayed";
        ...
        [TestMethod]
        public void GetScrappedListFailure()
        {
            test = extent.CreateTest("Validating Get Scrapped List Failure");


            expectedStatus = "Failed";
            description = "test case to test scrapped stock list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
