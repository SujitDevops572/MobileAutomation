...
{
    [TestClass]
    public class SortScrappedStock
    {
        ...
        [TestMethod]
        public void SortScrappedStockListSuccess()
        {
                ...
                try
                {
                    SortSuccess.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse5", "Scrapped stock");

                }


            //test = extent.CreateTest("Validating Sort Scrapped Stock List Success");

            //expectedStatus = "Passed";
            //description = "test case to test sort scrapped stock with available options. make sure current stock has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            catch (Exception ex)
            {
               ...
               [TestMethod]
                public void SortScrappedStockListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse5", "Scrapped stock");

            }



            //test = extent.CreateTest("Validating Sort Scrapped Stock List Failure");
