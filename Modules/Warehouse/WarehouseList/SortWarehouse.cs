...
namespace VMS_Phase1PortalAT.Modules.Warehouse.WarehouseList
{
    ...
    public class SortWarehouse
    {
        ...
        [TestMethod]
        public void SortWarehouseListSuccess()
        {
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse0", "Warehouse List");

            }



            //test = extent.CreateTest("Validating Sort Warehouse List Success");


            //expectedStatus = "Passed";
            //description = "test case to test sort warehouse with available options. make sure warehouse has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortWarehouseListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse0", "Warehouse List");

            }



            //test = extent.CreateTest("Validating Sor tWarehouse List Failure");


            //expectedStatus = "Failed";
            //description = "test case to test sort warehouse with available options. make sure warehouse has multiple datas before run. it pass only if there is an error in sorting";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
