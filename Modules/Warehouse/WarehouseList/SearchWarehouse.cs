...
namespace VMS_Phase1PortalAT.Modules.Warehouse.WarehouseList
{
    ...
    public class SearchWarehouse
    {
        ...
        [TestMethod]
        public void SearchWarehouseSuccess()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse0", SearchWarehouseData.searchWarehouseSuccess, 1, "Warehouse List");
            ...
            //test = extent.CreateTest("Validating Search Warehouse Success");

            //expectedStatus = "Passed";
            //description = "test case to search warehouse datas with valid datas so it return datas. add valid data in searchWarehouseSuccess in SearchWarehouseData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchWarehouseData.searchWarehouseSuccess[item.Text]);
        ...
        [TestMethod]
        public void SearchWarehouseFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse0", SearchWarehouseData.searchWarehouseFailure, 0, "Warehouse list");
            ...
            //test = extent.CreateTest("Validating Search Warehouse Failure");


            //expectedStatus = "Passed";
            //description = "test case to search warehouse datas with wrong datas so it returns no data. add invalid data in searchWarehouseFailure in SearchWarehouseData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchWarehouseData.searchWarehouseFailure[item.Text]);
            //                searchInput.SendKeys(Keys.Enter);
            //                Thread.Sleep(2000);
