...
namespace VMS_Phase1PortalAT.Modules.Warehouse.WarehouseList
{
    ...
    public class GetWarehouseList
    {
        ...
        [TestMethod]
        public void GetWarehouseListSuccess()
        {
            test = extent.CreateTest("Validating Get Warehouse List Success");

            expectedStatus = "Passed";
            description = "test case to test warehouse list displayed";
            ...
            try
            {
                ...
                if (menu != null)
                {
                    ...
                    if (submenu != null)
                    {
                        ...
                        wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(By.ClassName("mat-paginator-range-label")));
        ...
        [TestMethod]
        public void GetWarehouseListFailure()
        {
            test = extent.CreateTest("Validating Get Warehouse List Failure");


            expectedStatus = "Failed";
            description = "test case to test warehouse list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
