...
{
    [TestClass]
    public class SearchReturnedStock
    {
        ...
        [TestMethod]
        public void SearchReturnedStockSuccess()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse4", SearchReturnedStockeData.searchReturnedStockFailure, 1, "Returned Stock");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest(" seach returned stock");
            //description = "test case to search returned stock datas with valid datas so it return datas. add valid data in searchReturnedStockSuccess in SearchReturnedStockeData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchReturnedStockeData.searchReturnedStockSuccess[item.Text]);
        ...
        [TestMethod]
        public void SearchReturnedStockFailure()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse4", SearchReturnedStockeData.searchReturnedStockSuccess, 1, "Returned Stock");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("search of returned stock");
            //description = "test case to search returned stock datas with invalid datas so it return datas. add invalid data in searchReturnedStockFailure in SearchReturnedStockeData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchReturnedStockeData.searchReturnedStockFailure[item.Text]);
            //                searchInput.SendKeys(Keys.Enter);
            //                Thread.Sleep(2000);
