...
{
    [TestClass]
    public class SortReturnedStock
    {
        ...
        [TestMethod]
        public void SortReturnedStockListSuccess()
        {

            expectedStatus = "Passed";

            description = "Test case to sort Client Admin List";
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse4", "Returned stock");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("sort refund stock with available options");
            //description = "test case to test sort refund stock with available options. make sure current stock has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortReturnedStockListFailure()
        {

            expectedStatus = "Failed";

            description = "Verify all sort options of Client Admin List.";
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse4", "Returned stock");
            ...
            //expectedStatus = "Failed";
            //test = extent.CreateTest("Sort returned stock");
            //description = "test case to test sort returned stock with available options. make sure current stock has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
