...
{
    [TestClass]
    public class GetReturnedStockList
    {
        ...
        [TestMethod]
        public void GetReturnedListSuccess()
        {
            expectedStatus = "Passed";
            test = extent.CreateTest("refund stock list displayed");
            description = "test case to test refund stock list displayed";
        ...
        [TestMethod]
        public void GetReturnedListFailure()
        {
            expectedStatus = "Failed";
            test = extent.CreateTest("returned stock list is not displayed ");
            description = "test case to test returned stock list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
