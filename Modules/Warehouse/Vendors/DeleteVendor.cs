...
namespace VMS_Phase1PortalAT.Modules.Warehouse.Vendors
{
    ...
    public class DeleteVendor
    {
        ...
        [TestMethod]
        [Priority(0)]
        public void DeleteVendorSuccess()
        {
            test = extent.CreateTest("Validating Delete Vendor Success");

            expectedStatus = "Passed";
            description = "test case to test delete vendor which is not associated to anything which will get deleted. add valid data in DeleteVendorSuccess in DeleteVendorData file before run";
            ...
            try
            {
                ...
                if (menu != null)
                {
                    ...
                    if (submenu != null)
                    {
                        ...
                        searchInput.Clear();
                        searchInput.SendKeys(DeleteVendorData.DeleteVendorSuccess["name"]);
        ...
        [TestMethod]
        [Priority(0)]
        public void DeleteVendorFailure()
        {

            test = extent.CreateTest("Validating Delete Vendor Failure");

            expectedStatus = "Passed";
            description = "test case to test delete vendor which is associated to something which will not get deleted. add valid data in DeleteVendorFailure in DeleteVendorData file before run";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
            ...
            try
            {
                ...
                if (menu != null)
                {
                    ...
                    if (submenu != null)
                    {
                        ...
                        IWebElement searchInput = driver.FindElement(By.Name("searchText"));
                        searchInput.Clear();
                        searchInput.SendKeys(DeleteVendorData.DeleteVendorFailure["vendorId"]);
                        searchInput.SendKeys(Keys.Enter);
                        Thread.Sleep(1000);
                        IWebElement table = wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(By.TagName("tbody")));
                        IList<IWebElement> data = table.FindElements(By.TagName("tr"));
