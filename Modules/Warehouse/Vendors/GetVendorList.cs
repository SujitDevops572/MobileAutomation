...
namespace VMS_Phase1PortalAT.Modules.Warehouse.Vendors
{
    ...
    public class GetVendorList
    {
        ...
        {
            test = extent.CreateTest("Validating Get Vendor List Success");


            expectedStatus = "Passed";
            description = "test case to test vendor list displayed";
        ...
        [TestMethod]
        public void GetVendorListFailure()
        {
            test = extent.CreateTest("Validating Get Vendo List Failure");


            expectedStatus = "Failed";
            description = "test case to test vendors list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
