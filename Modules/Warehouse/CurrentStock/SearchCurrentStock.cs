...
{
    [TestClass]
    public class SearchCurrentStock
    {
        ...
        public void SearchCurrentStockSuccess()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse2", SearchCurrentStockeData.searchCurrentStockSuccess, 1, "Current Stock");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("Search cuurent stock");
            //description = "test case to search current stock datas with valid datas so it return datas. add valid data in searchCurrentStockSuccess in SearchCurrentStockeData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchCurrentStockeData.searchCurrentStockSuccess[item.Text]);
        ...
        public void SearchCurrentStockFailure()
        {
            ...
            description = "test case to  Search Client Admin List Failure";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Warehouse", "menuItem-Warehouse2", SearchCurrentStockeData.searchCurrentStockFailure, 0, "Current Stock");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("Search current stock with invalid datas");
            //description = "test case to search current stock datas with invalid datas so it return datas. add invalid data in searchCurrentStockFailure in SearchCurrentStockeData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchCurrentStockeData.searchCurrentStockFailure[item.Text]);
            //                searchInput.SendKeys(Keys.Enter);
            //                Thread.Sleep(2000);
