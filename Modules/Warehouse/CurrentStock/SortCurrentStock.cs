...
namespace VMS_Phase1PortalAT.Modules.Warehouse.CurrentStock
{
    ...
    public class SortCurrentStock
    {
        ...
        [TestMethod]
        public void SortCurrentStockListSuccess()
        {
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse2", "Current Stock");

            }


            //expectedStatus = "Passed";
            //test = extent.CreateTest("sort current stock");
            //description = "test case to test sort current stock with available options. make sure current stock has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortCurrentStockListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Warehouse", "menuItem-Warehouse2", "Current Stock");

            }


            //expectedStatus = "Failed";
            //test = extent.CreateTest("sort current stock with available options");
            //description = "test case to test sort current stock with available options. make sure current stock has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
