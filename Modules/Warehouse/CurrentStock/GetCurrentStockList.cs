...
namespace VMS_Phase1PortalAT.Modules.Warehouse.CurrentStock
{
    ...
    public class GetCurrentStockList
    {
        ...
        public void GetCurrentListSuccess()
        {
            ...
            test = extent.CreateTest("Current stock list ");
            description = "test case to test current stock list displayed";
        ...
        public void GetCurrentListFailure()
        {
            ...
            test = extent.CreateTest("Current stock list not displayed");
            description = "test case to test current stock list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
