...
namespace VMS_Phase1PortalAT.Modules.PurchaseOrder.CurrentPurchaseOrder
{
    ...
    [TestClass]
    public class SearchCurrentPurchaseOrder
{
        ...
        public void SearchCurrentPurchaseOrderSuccess()
        {
            ...
            try
            {
                SearchSuccess.SearchAction(driver, "menuItem-Purchase Order", "menuItem-Purchase Order0", SearchCurrentPurchaseOrderData.searchCurrentPurchaseOrderSuccess, 1, "Current Purchase Order");
        ...
        public void SearchCurrentPurchaseOrderFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Purchase Order", "menuItem-Purchase Order0", SearchCurrentPurchaseOrderData.searchCurrentPurchaseOrderFailure, 0, "Current Purchase Order");
