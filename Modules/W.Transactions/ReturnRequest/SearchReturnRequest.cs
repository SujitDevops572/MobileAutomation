...
namespace VMS_Phase1PortalAT.Modules.W.Transactions.ReturnRequest
{
    ...
    public class SearchReturnRequest
    {
        ...
        public void SearchReturnRequestSuccess()
        {
            ...
            description = "test case to Return Request Search Success";
            ...
            try
            {
                ...
                // Ensure login completes and the menu is present jkh
                wait.Until(driver =>
                {
            ...
            try
            {
                SearchSuccess.SearchAction(driver, "menuItem-W. Transactions", "menuItem-W. Transactions2", SearchReturnRequestData.searchReturnRequestSuccess, 1, "Return Request");
        ...
        public void SearchReturnRequestFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-W. Transactions", "menuItem-W. Transactions3", SearchReturnRequestData.searchReturnRequestFailure, 0, "Return Request");
