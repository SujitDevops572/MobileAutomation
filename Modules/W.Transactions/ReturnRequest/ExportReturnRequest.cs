...
namespace VMS_Phase1PortalAT.Modules.W.Transactions.ReturnRequest
{
    ...
    public class ExportReturnRequest
    {
        ...
        [TestMethod]
        public void ExportReturnRequestSuccess()
        {
            test = extent.CreateTest("Export Return Request");
            expectedStatus = "Passed";
            description = "Test case to verify export functionality in Return Request";
            ...
            try
            {
                ...
                IWebElement menu = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("menuItem-W. Transactions")));
                ClickElementWithRetries(driver, menu, "Main Menu");

                IWebElement submenu = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("menuItem-W. Transactions3")));
