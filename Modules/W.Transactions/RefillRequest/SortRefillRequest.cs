...
namespace VMS_Phase1PortalAT.Modules.W.Transactions.RefillRequest
{
    ...
    public class SortRefillrequest
    {
        ...
        public void SortRefillRequestSuccess()
        {
            ...
            description = "Test case to sort Refill Request Request";
            ...
            try
            {
                ...
                SortSuccess.Sort(driver, "menuItem-W. Transactions", "menuItem-W. Transactions2", "Refill Request");
        ...
        public void SortRefillRequestFailure()
        {
            ...
            description = "Test case to validate sort functionality in Refill Request module";
            ...
            try
            {
                ...
                SortFailure.Sort(driver, "menuItem-W. Transactions", "menuItem-W. Transactions2", "Refill Request");
