...
namespace VMS_Phase1PortalAT.Modules.W.Transactions.RefillRequest
{
    ...
    public class DateRangeRefillRequest
    {
        ...
        public void DateRangeRefillRequestSuccess()
        {
            ...
            description = "Test for date filter in refill request with valid date range";
            ...
            try
            {
                DateRange.DateTimeAction(driver, "menuItem-W. Transactions", "menuItem-W. Transactions2", PurchaseSearchStockData.DateRange, "Refill Request");
