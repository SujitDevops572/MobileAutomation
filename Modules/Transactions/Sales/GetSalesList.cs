...
namespace VMS_Phase1PortalAT.Modules.Transaction.Sales
{
    ...
    public class GetSalesList
    {
        ...
        [TestMethod]
        public void GetSalesListSuccess()
        {
            expectedStatus = "Passed";
            test = extent.CreateTest("Sales List ");
            description = "test case to test sales list displayed";
        ...
        [TestMethod]
        public void GetSalesListFailure()
        {
            expectedStatus = "Failed";
            test = extent.CreateTest("sales list ");
            description = "test case to test sales list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
