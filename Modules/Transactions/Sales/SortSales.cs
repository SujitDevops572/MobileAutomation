...
namespace VMS_Phase1PortalAT.Modules.Transaction.Sales
{
    ...
    public class SortSales
    {
        ...
        [TestMethod]
        public void SortSalesListSuccess()
        {
            ...
            try
            {
                SortSuccess_sales.Sort(driver, "menuItem-Transactions", "menuItem-Transactions0", "Sales");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("sort the sales");
            //description = "test case to test sort sales with available options. make sure sort has multiple datas before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortSalesListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Transactions", "menuItem-Transactions0", "Sales");
            }



            //expectedStatus = "Failed";
            //test = extent.CreateTest("Available sales");
            //description = "test case to test sort sales with available options. make sure sales has multiple datas before run. it pass only if there is an error in sorting";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
