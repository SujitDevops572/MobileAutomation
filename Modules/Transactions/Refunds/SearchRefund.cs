...
using VMS_Phase1PortalAT.utls.datas.PurchaseOrder.OldPurchaseOrder;
using VMS_Phase1PortalAT.utls.datas.Transactions.Refunds;
...
namespace VMS_Phase1PortalAT.Modules.Transaction.Refunds
{
    ...
    public class SearchRefund
    {
        ...
        [TestMethod]
        public void SearchRefundSuccess()
        {
            ...
            try
            {
                SearchSuccess.SearchAction(driver, "menuItem-Transactions", "menuItem-Transactions1", SearchRefundData.searchRefundSuccess, 1, "Refund");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest("Search Refund");
            //description = "test case to search refund datas with valid datas so it return datas. add valid data in searchRefundSuccess in SearchRefundData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchRefundData.searchRefundSuccess[item.Text]);
        ...
        [TestMethod]
        public void SearchRefundFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Transactions", "menuItem-Transactions1", SearchRefundData.searchRefundFailure, 0, "Refund");
            ...
            //expectedStatus = "Passed";
            //test = extent.CreateTest(" Refund data with wrong data");
            //description = "test case to search refund datas with wrong datas so it returns no data. add invalid data in searchRefundFailure in SearchRefundData file before run";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //            IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //            searchInput.Clear();
            //            searchInput.SendKeys(SearchRefundData.searchRefundFailure[item.Text]);
            //            searchInput.SendKeys(Keys.Enter);
            //            Thread.Sleep(2000);
