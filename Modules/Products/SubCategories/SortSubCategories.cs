...
{
    [TestClass]
    public class SortSubCategories
    {
        ...
        [TestMethod]
        public void SortSubCategoriesListSuccess()
        {
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Products", "menuItem-Products2", "SubCategories");
            ...
            //test = extent.CreateTest("Validating Sort SubCategories List Success");

            //expectedStatus = "Passed";
            //description = "test case to test sort sub categories";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        [TestMethod]
        public void SortSubCategoriesListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Products", "menuItem-Products2", "SubCategories");
            }




            //test = extent.CreateTest("Validating Sort SubCategories List Failure");
