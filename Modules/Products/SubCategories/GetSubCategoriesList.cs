...
{
    [TestClass]
    public class GetSubCategoriesList
    {
        ...
        public void GetSubCategoryListSuccess()
        {
            ...
            test = extent.CreateTest("Validating  Get SubCategory List Success");

            expectedStatus = "Passed";
            description = "test case to test sub category list";
        ...
        [TestMethod]
        public void GetSubCategoryListFailure()
        {
            test = extent.CreateTest("Validating  Get SubCategory List Failure");


            expectedStatus = "Failed";
            description = "test case to test sub categories list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
