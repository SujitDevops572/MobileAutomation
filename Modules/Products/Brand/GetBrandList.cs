...
namespace VMS_Phase1PortalAT.Modules.Products.Brand
{
    ...
    public class GetBrandList
    {
        ...
        {
            test = extent.CreateTest("Validating get brand datas");

            expectedStatus = "Passed";
            description = "test case to test get brand datas";
        ...
        [TestMethod]
        public void GetBrandListFailure()
        {
            test = extent.CreateTest("Validating  brand list is not displayed");

            expectedStatus = "Failed";
            description = "test case to test brand list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
