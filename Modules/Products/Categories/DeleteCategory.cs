...
namespace VMS_Phase1PortalAT.Modules.Products.Categories
{
    ...
    public class DeleteCategory
    {
        ...
        public void DeleteCategorySuccess()
        {
            ...
            test = extent.CreateTest("Validating delete category Success");

            expectedStatus = "Passed";
            description = "test case to test delete category. add valid data in DeleteCategorySuccess in DeletecategoryData file";
            ...
            try
            {
                ...
                if (menu != null)
                {
                    ...
                    if (submenu != null)
                    {
                        ...
                        searchInput.Clear();
                        searchInput.SendKeys(DeletecategoryData.DeleteCategorySuccess["Name"]);
                        ...
                        if (datas.Count > 0)
                        {
                            ...
                            Assert.IsTrue(isSuccess, "Category deleted..");
                            test.Pass();
        ...
        [TestMethod]
        public void DeleteCategoryFailure()
        {
            test = extent.CreateTest("Validating delete brand Failure");

            expectedStatus = "Passed";
            description = "test case to test delete brand. add valid data in DeleteCategoryFailure in DeletecategoryData file";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
            ...
            try
            {
                ...
                if (menu != null)
                {
                    ...
                    if (submenu != null)
                    {
                        ...
                        IWebElement searchInput = driver.FindElement(By.Name("searchText"));
                        searchInput.Clear();
                        searchInput.SendKeys(DeletecategoryData.DeleteCategoryFailure["categoryId"]);
                        searchInput.SendKeys(Keys.Enter);
                        Thread.Sleep(1000);
                        wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(By.ClassName("mat-focus-indicator")));
                        IWebElement actions = driver.FindElement(By.ClassName("mat-focus-indicator"));
