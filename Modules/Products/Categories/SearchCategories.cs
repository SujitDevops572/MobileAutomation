...
namespace VMS_Phase1PortalAT.Modules.Products.Categories
{
    ...
    public class SearchCategories
    {
        ...
        [TestMethod]
        public void SearchCategorySuccess()
        {
            ...
            try
            {
                ...
                SearchSuccess.SearchAction(driver, "menuItem-Products", "menuItem-Products1", SearchCategoryData.searchCategorySuccess, 1, "Categories");
            ...
            //test = extent.CreateTest("Validating Search Category Success");

            //expectedStatus = "Passed";
            //description = "test case to test search category. add valid data searchCategorySuccess in SearchCategoryData file";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
            ...
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchCategoryData.searchCategorySuccess[item.Text]);
        ...
        [TestMethod]
        public void SearchCategoryFailure()
        {
            ...
            try
            {
                ...
                SearchFailure.SearchAction(driver, "menuItem-Products", "menuItem-Products1", SearchCategoryData.searchCategoryFailure, 0, "Categories");
            ...
            //test = extent.CreateTest("Validating Search Category Failure");
            ...
            //                IWebElement searchInput = driver.FindElement(By.Name("searchText"));
            //                searchInput.Clear();
            //                searchInput.SendKeys(SearchCategoryData.searchCategoryFailure[item.Text]);
            //                searchInput.SendKeys(Keys.Enter);
            //                Thread.Sleep(2000);
            //                IWebElement table = driver.FindElement(By.TagName("tbody"));
            //                IList<IWebElement> datas = table.FindElements(By.TagName("tr"));
