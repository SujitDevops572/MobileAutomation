...
namespace VMS_Phase1PortalAT.Modules.Products.Categories
{
    ...
    public class SortCategories
    {
        ...
        [TestMethod]
        public void SortCategoriesListSuccess()
        {
            ...
            try
            {
                SortSuccess.Sort(driver, "menuItem-Products", "menuItem-Products1", "Categories");

            }



            //test = extent.CreateTest("Validating Sort Categories List Success");

            //expectedStatus = "Passed";
            //description = "test case to sort category";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
        ...
        public void SortCategoriesListFailure()
        {
            ...
            try
            {
                SortFailure.Sort(driver, "menuItem-Products", "menuItem-Products1", "Categories");
            ...
            //test = extent.CreateTest("Validating Sort Categories List Failure");


            //expectedStatus = "Failed";
            //description = "test case to sort category fail";
            //Login LoginSuccess = new Login();
            //driver = LoginSuccess.getdriver();
            //try
            //{
