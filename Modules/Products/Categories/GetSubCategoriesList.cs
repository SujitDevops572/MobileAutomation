...
namespace VMS_Phase1PortalAT.Modules.Products.Categories
{
    ...
    public class GetSubCategoriesList
    {
        ...
        {
            test = extent.CreateTest("Validating Get Category List Success");

            expectedStatus = "Passed";
            description = "test case to test get categories";
        ...
        {
            test = extent.CreateTest("Validating Get Category List Failure");

            expectedStatus = "Failed";
            description = "test case to test  categories list is not displayed. this test case pass only if there is any error on getting datas or no data present in database";
            Login LoginSuccess = new Login();
            driver = LoginSuccess.getdriver();
            try
            {
